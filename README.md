...
This project is part of my undergraduate thesis in Computer Science. The goal is to contribute practical insights about multi-agent AI systems for mobile testing — what's possible today, where the limitations are, and how different orchestration strategies compare.
